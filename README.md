...
2. **CSS-переменные** — обязательное использование CSS-переменных для свойств: `color` и всех производных от него. Все остальные свойства должны быть в алфавитном порядке
